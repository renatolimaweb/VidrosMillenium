...
if ($colname_search_data) {
	$query_search_data = sprintf("SELECT * FROM widget WHERE id_widget = '$colname_search_data'");
...
<html class="fixed dark">
	<head>
		...
		<title>Widget - Sistema Gerenciador de Conteúdo</title>
		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
                    ...
                    <div class="card-body">
					<form method="post" name="controle" class="form-horizontal form-bordered" role="form" <? if ($colname_search_data) { ?> action="classes/update-widget.php" <? } else { ?> action="classes/insert-widget.php" <? } ?> onSubmit="return checkForm(this)" ENCTYPE="multipart/form-data">
                                            
											<div class="form-group row">
												<label class="col-md-3 control-label text-lg-right" for="inputDefault">Título</label>
												<div class="col-md-6">
													<input name="title_widget" type="text" class="form-control" id="inputDefault" data-plugin-maxlength maxlength="200" value="<?=$row_search_data["title_widget"];?>" required>
												</div>
											</div>
                                            
                                            <div class="form-group row">
												<div class="col-md-12">
													<textarea name="text" id="text"><?=$row_search_data["content_widget"];?></textarea>
												</div>
											</div>
                                            ...
                                            <div class="form-group row">
                                             ...
                                             <div class="col-md-9">
											  ...
											  <input id="status_widget" name="status_widget" value="1" type="checkbox" name="switch" data-plugin-ios-switch <?php if (!(strcmp(1, $row_search_data['status_widget']))) {echo "checked=\"checked\"";} else{ echo ""; } ?>/>
                                              </div>
											 </div>
                                            </div>
                                            <div class="form-group row">
											...
											<? if ($row_search_data["id_widget"]){ ?>
      										<input name="id_widget" type="hidden" id="id_widget" value="<?=$row_search_data["id_widget"];?>" />
											<? } ?>
										</form>
									</div>
