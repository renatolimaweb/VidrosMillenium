...
if ($colname_search_data) {
	$query_search_data = sprintf("SELECT * FROM category_video WHERE id_category_video = '$colname_search_data'");
...
<html class="fixed dark">
	<head>
		...
		<title>Controle Categoria de Vídeos - Sistema Gerenciador de Conteúdo</title>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Controle de Categoria de Vídeos</h2>
					</header>
                    ...
                    <div class="card-body">
					<form method="post" name="controle" class="form-horizontal form-bordered" role="form" <? if ($colname_search_data) { ?> action="classes/update-category-video.php" <? } else { ?> action="classes/insert-category-video.php" <? } ?> onSubmit="return checkForm(this)" ENCTYPE="multipart/form-data">
                                            
                                            
											<div class="form-group row">
												<label class="col-md-3 control-label text-lg-right" for="inputDefault">Título</label>
												<div class="col-md-6">
													<input name="title_category_video" type="text" class="form-control" id="inputDefault" data-plugin-maxlength maxlength="200" value="<?=$row_search_data["title_category_video"];?>" required>
												</div>
											</div>
                                            ...
                                            <div class="form-group row">
												...
												<div class="col-md-6">
													<input name="icon_category_video" type="text" class="form-control" id="inputDefault" data-plugin-maxlength maxlength="200" value="<?=$row_search_data["icon_category_video"];?>">
												</div>
											</div>
                                            ...
                                            <div class="form-group row">
												...
												<div class="col-md-6">
													<select id="position_category_video" name="position_category_video" class="form-control mb-md">
														<option value="1" <?php if (!(strcmp(1, $row_search_data['position_category_video']))) {echo "selected=\"selected\"";} ?>>Menu Principal</option>
                                                        <option value="5" <?php if (!(strcmp(2, $row_search_data['position_category_video']))) {echo "selected=\"selected\"";} ?>>Internas</option>
													</select>
												</div>
											</div>
                                            ...
                                            <div class="form-group row">
                                             ...
                                             <div class="col-md-9">
											  ...
											  <input id="status_category_video" name="status_category_video" value="1" type="checkbox" name="switch" data-plugin-ios-switch <?php if (!(strcmp(1, $row_search_data['status_category_video']))) {echo "checked=\"checked\"";} else{ echo ""; } ?>/>
                                              </div>
											 </div>
                                            </div>
                                            <div class="form-group row">
											...
											<? if ($row_search_data["id_category_video"]){ ?>
      										<input name="id_category_video" type="hidden" id="id_post" value="<?=$row_search_data["id_category_video"];?>" />
											<? } ?>
										</form>
									</div>
