...
if ($colname_search_data) {
	$query_search_data = sprintf("SELECT * FROM page WHERE id_page = '$colname_search_data'");
...
<html class="fixed dark">
	<head>
		...
		<title>Páginas - Sistema Gerenciador de Conteúdo</title>
		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
                    ...
                    <div class="card-body">
					<form method="post" name="controle" class="form-horizontal form-bordered" role="form" <? if ($colname_search_data) { ?> action="classes/update-page.php" <? } else { ?> action="classes/insert-page.php" <? } ?> onSubmit="return checkForm(this)" ENCTYPE="multipart/form-data">
                                           ...
                                           <div class="form-group row">
													...
													<div class="col-md-6">
														<div class="input-group">
															...
															<input name="date_page" id="date" data-plugin-datepicker data-input-mask="99/99/9999" placeholder="__/__/____" class="form-control" value="<? if ($row_search_data["date_page"]) {
																$datatrans = explode ("-", $row_search_data["date_page"]); 
											...
											<div class="form-group row">
												...
												<div class="col-md-6">
													<input name="title_page" type="text" class="form-control" id="inputDefault" data-plugin-maxlength maxlength="200" value="<?=$row_search_data["title_page"];?>" required>
												</div>
											</div>
                                            ...
                                            <div class="form-group row">
												...
												<div class="col-md-6">
													<textarea id="desc_page" name="desc_page" class="form-control" rows="3" data-plugin-maxlength maxlength="240"><?=$row_search_data["desc_page"];?></textarea>
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-6">
													<input name="tags_page" id="tags_page" data-role="tagsinput" data-tag-class="label label-primary" class="form-control" value="<?=$row_search_data["tags_page"];?>" />
												</div>
											</div>
                                            ...
                                            <div class="form-group row">
													<?php
														...
														$oFCKeditor = new FCKeditor('texto_page');
														$oFCKeditor->BasePath = 'FCKeditor/';
														$oFCKeditor->Value = $row_search_data["texto_page"];
													...
													?>
												<div class="col-md-12">
													<textarea name="text" id="text"><?=$row_search_data["text_page"];?></textarea>
												</div>
											</div>
                                            
                                            <div class="form-group row">
                                             <div class="col-sm-12 text-center">
                                             <? if ($row_search_data["image_page"]) { ?>
                                             	<p>Pré-Visualização:</p>
                                             	<img class="img-responsive" src="../content/img/<?=$row_search_data["image_page"];?>" />
											 <? } ?>
                                             </div>
                                            </div>
													...
													<div class="fileupload fileupload-new" data-provides="fileupload">
														<div class="input-append">
															...
															<span class="btn btn-default btn-file">
																...
																<input name="image_page" id="image_page" type="file" />
															</span>
                                            ...
                                            <div class="form-group row">
                                             ...
                                             <div class="col-md-9">
											  ...
											  <input id="status_page" name="status_page" value="1" type="checkbox" name="switch" data-plugin-ios-switch <?php if (!(strcmp(1, $row_search_data['status_page']))) {echo "checked=\"checked\"";} else{ echo ""; } ?>/>
                                              </div>
											 </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <input name="image_page_original" type="hidden" id="image_page_original" value="<?=$row_search_data["image_page"];?>" />
											<? if ($row_search_data["id_page"]){ ?>
      										<input name="id_page" type="hidden" id="id_page" value="<?=$row_search_data["id_page"];?>" />
											<? } ?>
										</form>
									</div>
