...
if ($colname_search_data) {
	$query_search_data = sprintf("SELECT * FROM link WHERE id_link = '$colname_search_data'");
...
<html class="fixed dark">
	<head>
		...
		<title>Links úteis - Sistema Gerenciador de Conteúdo</title>
		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
                    ...
                    <div class="card-body">
					<form method="post" name="controle" class="form-horizontal form-bordered" role="form" <? if ($colname_search_data) { ?> action="classes/update-link.php" <? } else { ?> action="classes/insert-link.php" <? } ?> onSubmit="return checkForm(this)" ENCTYPE="multipart/form-data">
                                            
											<div class="form-group row">
												<label class="col-md-3 control-label text-lg-right" for="inputDefault">Título</label>
												<div class="col-md-6">
													<input name="title_link" type="text" class="form-control" id="inputDefault" data-plugin-maxlength maxlength="200" value="<?=$row_search_data["title_link"];?>" required>
												</div>
											</div>
                                            ...
                                            <div class="form-group row">
												...
												<div class="col-md-6">
													<textarea id="url_link" name="url_link" class="form-control" rows="3" data-plugin-maxlength maxlength="240"><?=$row_search_data["url_link"];?></textarea>
												</div>
											</div>
                                            ...
                                            <div class="form-group row">
                                             ...
                                             <div class="col-md-9">
											  ...
											  <input id="status_link" name="status_link" value="1" type="checkbox" name="switch" data-plugin-ios-switch <?php if (!(strcmp(1, $row_search_data['status_link']))) {echo "checked=\"checked\"";} else{ echo ""; } ?>/>
                                              </div>
											 </div>
                                            </div>
                                            <div class="form-group row">
											...
											<? if ($row_search_data["id_link"]){ ?>
      										<input name="id_link" type="hidden" id="id_link" value="<?=$row_search_data["id_link"];?>" />
											<? } ?>
										</form>
									</div>
