...
if ($colname_search_data) {
	$query_search_data = sprintf("SELECT * FROM slideshow WHERE id_slideshow = '$colname_search_data'");
...
<html class="fixed dark">
	<head>
		...
		<title>Slideshow - Sistema Gerenciador de Conteúdo</title>
		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
                    ...
                    <div class="card-body">
					<form method="post" name="controle" class="form-horizontal form-bordered" role="form" <? if ($colname_search_data) { ?> action="classes/update-slideshow.php" <? } else { ?> action="classes/insert-slideshow.php" <? } ?> onSubmit="return checkForm(this)" ENCTYPE="multipart/form-data">
                                            
											<div class="form-group row">
												<label class="col-md-3 control-label text-lg-right" for="inputDefault">Título</label>
												<div class="col-md-6">
													<input name="title_slideshow" type="text" class="form-control" id="inputDefault" data-plugin-maxlength maxlength="200" value="<?=$row_search_data["title_slideshow"];?>" required>
												</div>
											</div>
                                            ...
                                            <div class="form-group row">
												...
												<div class="col-md-6">
													<textarea id="desc_slideshow" name="desc_slideshow" class="form-control" rows="3" data-plugin-maxlength maxlength="240"><?=$row_search_data["desc_slideshow"];?></textarea>
												</div>
											</div>
						
											<div class="form-group row">
												<label class="col-md-3 control-label text-lg-right" for="inputDefault">Url</label>
												<div class="col-md-6">
													<input name="url_slideshow" type="text" class="form-control" id="inputDefault" data-plugin-maxlength maxlength="200" value="<?=$row_search_data["url_slideshow"];?>" required>
												</div>
											</div>
                                            
                                            <div class="form-group row">
                                             <div class="col-sm-12 text-center">
                                             <? if ($row_search_data["image_slideshow"]) { ?>
                                             	<p>Pré-Visualização:</p>
                                             	<img class="img-responsive" src="../content/img/<?=$row_search_data["image_slideshow"];?>" />
											 <? } ?>
                                             </div>
                                            </div>
													...
													<div class="fileupload fileupload-new" data-provides="fileupload">
														<div class="input-append">
															...
															<span class="btn btn-default btn-file">
																...
																<input name="image_slideshow" id="image_slideshow" type="file" />
															</span>
                                            ...
                                            <div class="form-group row">
                                             ...
                                             <div class="col-md-9">
											  ...
											  <input id="status_slideshow" name="status_slideshow" value="1" type="checkbox" name="switch" data-plugin-ios-switch <?php if (!(strcmp(1, $row_search_data['status_slideshow']))) {echo "checked=\"checked\"";} else{ echo ""; } ?>/>
                                              </div>
											 </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <input name="image_slideshow_original" type="hidden" id="image_slideshow_original" value="<?=$row_search_data["image_slideshow"];?>" />
											<? if ($row_search_data["id_page"]){ ?>
      										<input name="id_slideshow" type="hidden" id="id_slideshow" value="<?=$row_search_data["id_slideshow"];?>" />
											<? } ?>
										</form>
									</div>
