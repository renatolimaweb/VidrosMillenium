...
if ($colname_search_data) {
	$query_search_data = sprintf("SELECT * FROM social_network WHERE id_social_network = '$colname_search_data'");
...
<html class="fixed dark">
	<head>
		...
		<title>Redes Sociais - Sistema Gerenciador de Conteúdo</title>
		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
                    ...
                    <div class="card-body">
					<form method="post" name="controle" class="form-horizontal form-bordered" role="form" <? if ($colname_search_data) { ?> action="classes/update-social-network.php" <? } else { ?> action="classes/insert-social-network.php" <? } ?> onSubmit="return checkForm(this)" ENCTYPE="multipart/form-data">
                                            
											<div class="form-group row">
												<label class="col-md-3 control-label text-lg-right" for="inputDefault">Título</label>
												<div class="col-md-6">
													<input name="title_social_network" type="text" class="form-control" id="inputDefault" data-plugin-maxlength maxlength="200" value="<?=$row_search_data["title_social_network"];?>" required>
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-6">
													<input name="icon_social_network" type="text" class="form-control" id="inputDefault" data-plugin-maxlength maxlength="200" value="<?=$row_search_data["icon_social_network"];?>" required>
												</div>
											</div>
                                            
                                            <div class="form-group row">
												<label class="col-md-3 control-label text-lg-right" for="textareaDefault">Url</label>
												<div class="col-md-6">
													<textarea id="url_social_network" name="url_social_network" class="form-control" rows="3" data-plugin-maxlength maxlength="240"><?=$row_search_data["url_social_network"];?></textarea>
												</div>
											</div>
                                            ...
                                            <div class="form-group row">
                                             ...
                                             <div class="col-md-9">
											  ...
											  <input id="status_social_network" name="status_social_network" value="1" type="checkbox" name="switch" data-plugin-ios-switch <?php if (!(strcmp(1, $row_search_data['status_social_network']))) {echo "checked=\"checked\"";} else{ echo ""; } ?>/>
                                              </div>
											 </div>
                                            </div>
                                            <div class="form-group row">
											...
											<? if ($row_search_data["id_social_network"]){ ?>
      										<input name="id_social_network" type="hidden" id="id_social_network" value="<?=$row_search_data["id_social_network"];?>" />
											<? } ?>
										</form>
									</div>
