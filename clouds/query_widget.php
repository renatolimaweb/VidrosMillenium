			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
                    ...
                    <section class="card">
						<div class="card-body">
							<div class="input-group mb-md">
                             <a href="widget_control.php?tp=<?=$type_content;?>"><span class="btn btn-lg btn-success"><i class="fa fa-check"></i> Cadastrar</span></a>
							</div>
						</div>
					</section>
				...
				if ($_REQUEST["Consulta"] != "") {
					$descsearch = $_REQUEST['search'];
						...
						$sql = "SELECT * FROM widget WHERE (title_widget like '%$descsearch%') ORDER BY title_widget DESC";
						}
						if ($category_user_valid <> 1) {
						$sql = "SELECT * FROM widget WHERE (title_widget like '%$descsearch%') ORDER BY title_widget DESC";
						}
					...
					if ($_REQUEST['Del'] == "del") {
						$code = $_REQUEST['code'];
						$sql = "DELETE FROM widget WHERE id_widget = '$code'";
						...
						//}
						//if ($category_user_valid <> 1) {
						$sql = "SELECT * FROM widget ORDER BY id_widget DESC";
						//}
				}
				...
				$code 			    = $row["id_widget"];
				$title	        	= $row["title_widget"];
				$status             = $row["status_widget"];
				...
				?>
                             <section class="card">
                                    ...
                                    <div class="col-md-12">
                                        <p class="pull-right">
                                         <a href="widget_control.php?cod=<?=$code;?>" title="Editar"><span class="btn btn-warning"><i class="fas fa-edit"></i></span></a>
                                         <a href="query_widget.php?Del=del&amp;code=<?=$code?>" onclick="return confirm('Deseja excluir ?')" title="Excluir"><span class="btn btn-danger"><i class="fas fa-trash-alt"></i></span></a>
                                        </p>
