...
$insertContent = "INSERT INTO page (date_page, title_page, desc_page, tags_page, text_page, image_page, status_page) VALUES ('$data', '$title', '$desc', '$tags', '$text', '$nova_imagem', '$status')";
