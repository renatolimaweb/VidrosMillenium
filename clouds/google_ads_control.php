...
<html class="fixed dark">
	<head>
		...
		<title>Google Ads - Sistema Gerenciador de Conteúdo</title>
		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
                    ...
                    <div class="card-body">
					<form method="post" name="controle" class="form-horizontal form-bordered" role="form" <? if ($colname_search_data) { ?> action="classes/update-google-ads.php" <? } else { ?> action="classes/insert-page.php" <? } ?> onSubmit="return checkForm(this)" ENCTYPE="multipart/form-data">
                                            
                                            <div class="form-group row">
												<label class="col-md-3 control-label text-lg-right" for="textareaDefault">Script de incorporação:</label>
												<div class="col-md-6">
													<textarea id="api_google_ads" name="api_google_ads" class="form-control" rows="3" data-plugin-maxlength maxlength="240"><?=$row_search_data["api_google_ads"];?></textarea>
												</div>
											</div>
